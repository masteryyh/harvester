...
SQUASHFS_FILENAME="rootfs.squashfs"
UPGRADE_REPO_SQUASHFS_IMAGE="$UPGRADE_REPO_URL/$SQUASHFS_FILENAME"
UPGRADE_REPO_SQUASHFS_IMAGE_CHECKSUM="$UPGRADE_REPO_URL/rootfs.squashfs.sha512"
